package com.example.moneybook.tool.chart;
...
public class ChartViewBuilder {
	...
	private static String TAG = ChartViewBuilder.class.getSimpleName();
	
	private static ChartViewBuilder instance = null;
	
	public static ChartViewBuilder getInstance(){
		if(instance == null){
			instance = new ChartViewBuilder();
		}
		return instance;
	}
	...
	public void startDrawLinChart(Context context, View rootView,int viewId,  int[] x, int[] income, int[] expense, String[] mMonth){
		...
		*/
		...
		LinearLayout chartContainer = (LinearLayout) rootView.findViewById(viewId);
